...
geom_text(aes(x = xo, yo, label = n), family = "Inconsolata Semibold", size = 4.5) +
...
caption = "Tidytuesday Week-11 2023<br> Data from **European Medicines Agency**") +
coord_equal() +
theme_minimal() +
theme(
text = element_text(color = "white"),
plot.title = element_text(family = "Go Condensed Medium", face = "bold", size = rel(2.5)),
...
# Saving ------------------------------------------------------------------
path = here::here("tidytuesday_2023_w11")
ggsave(filename = glue::glue("{path}.png"), width = 9, height = 13.5,  dpi = 300)
